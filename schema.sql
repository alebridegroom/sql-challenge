...
-- 4. List first name, last name, and sex of each employee whose first name is 
...
--5. List each employee in the Sales department, including their employee number, 
...
-- 6. List each employee in the Sales and Development departments, 
...
-- 7. List the frequency counts, in descending order, of all the 
